...
st.plotly_chart(plotchart.line_plot_df(u_df,'Date','Users','Unique Users'))
...
for table_type in ['orders','lots','strategies']:
    ...
    cur_col.plotly_chart(plotchart.bar_plot_df(bro_df,'Date','Brokers',table_type.upper()))
    cur_col.plotly_chart(plotchart.bar_plot_df(stra_df,'Date','Strategies',table_type.upper()))
